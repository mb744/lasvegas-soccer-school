...
namespace SoccerSchool.Api.Data.Migrations
{
    ...
    [Migration("20260926060836_AddMobileAppSettings")]
    partial class AddMobileAppSettings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SoccerSchool.Api.Domain.Announcement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SoccerSchool.Api.Domain.ChatMessageReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SoccerSchool.Api.Domain.ChatUserBlock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SoccerSchool.Api.Domain.EventMedia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ScheduledGameId", "CreatedAt");
            ...
            modelBuilder.Entity("SoccerSchool.Api.Domain.HostedTournament", b =>
                {
                    ...
                    b.Property<string>("ScheduleEmailBody")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("SoccerSchool.Api.Domain.KnownPermission", b =>
                {
            ...
            modelBuilder.Entity("SoccerSchool.Api.Domain.MediaAsset", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SoccerSchool.Api.Domain.MobileAppInstall", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("MobileAppInstalls");
                });

            modelBuilder.Entity("SoccerSchool.Api.Domain.MobileAppSettings", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SoccerSchool.Api.Domain.ParentAccount", b =>
                {
                    ...
                    b.Property<string>("ReclaimEmailHash")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
                    ...
                    b.HasIndex("ReclaimEmailHash")
                        .HasFilter("[ReclaimEmailHash] IS NOT NULL");
            ...
            modelBuilder.Entity("SoccerSchool.Api.Domain.PermissionAuditEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PermissionAuditEntries");
                });
            ...
            modelBuilder.Entity("SoccerSchool.Api.Domain.RolePermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SoccerSchool.Api.Domain.UserPermissionGrant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SoccerSchool.Api.Domain.ChatMessage", b =>
                {
                    ...
                    b.HasOne("SoccerSchool.Api.Domain.MediaAsset", "MediaAsset")
                        .WithMany()
            ...
            modelBuilder.Entity("SoccerSchool.Api.Domain.ChatMessageReport", b =>
                {
                    b.HasOne("SoccerSchool.Api.Domain.ChatMessage", "ChatMessage")
                        .WithMany()
